...
public class AchiItem_21 : AchievementItemManager
{
    public int code = 21;   //업적 넘버링
    public string title = "거의 다왔어"; //업적 제목
    private string require = "7스테이지에서 100번 점프"; //업적 달성 조건 문구
    private int levelNum = 1; //별 개수(레벨)
    private string clmName = "jumpStage7"; //컬럼 이름
