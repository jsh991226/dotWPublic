...
public class AchiItem_14 : AchievementItemManager
{
    public int code = 14;   //업적 넘버링
    public string title = "어디서 맛있는 개구리 냄새가..?"; //업적 제목
    private string require = "3스테이지 악어 위에서 100번 점프"; //업적 달성 조건 문구
