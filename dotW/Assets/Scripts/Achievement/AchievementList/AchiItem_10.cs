...
public class AchiItem_10 : AchievementItemManager
{
    public int code = 10;   //업적 넘버링
    public string title = "지렁이는 어딨을까?"; //업적 제목
    private string require = "2스테이지에서 점프 100번"; //업적 달성 조건 문구
    private int levelNum = 1; //별 개수(레벨)
    private string clmName = "jumpStage2"; //컬럼 이름
