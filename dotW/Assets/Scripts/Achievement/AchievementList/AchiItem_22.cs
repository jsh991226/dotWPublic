...
public class AchiItem_22 : AchievementItemManager
{
    public int code = 22;   //업적 넘버링
    public string title = "우물 밖은 위험해"; //업적 제목
    private string require = "사망 횟수 1번"; //업적 달성 조건 문구
