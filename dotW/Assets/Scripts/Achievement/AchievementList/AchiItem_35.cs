...
public class AchiItem_35 : AchievementItemManager
{
    public int code = 35;   //업적 넘버링
    public string title = "Dancing outside the Manhole"; //업적 제목
    private string require = "4스테이지에서 사망 횟수 30번"; //업적 달성 조건 문구
