...
public class AchiItem_16 : AchievementItemManager
{
    public int code = 16;   //업적 넘버링
    public string title = "삭막한 분위기와 공기"; //업적 제목
    private string require = "4스테이지에서 점프 100번"; //업적 달성 조건 문구
    private int levelNum = 1; //별 개수(레벨)
    private string clmName = "jumpStage4"; //컬럼 이름
