...
public class AchiItem_20 : AchievementItemManager
{
    public int code = 20;   //업적 넘버링
    public string title = "마지막 고비"; //업적 제목
    private string require = "6스테이지에서 100번 점프"; //업적 달성 조건 문구
    private int levelNum = 1; //별 개수(레벨)
    private string clmName = "jumpStage6"; //컬럼 이름
