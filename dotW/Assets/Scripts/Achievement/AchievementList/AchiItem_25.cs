...
public class AchiItem_25 : AchievementItemManager
{
    public int code = 25;   //업적 넘버링
    public string title = "이번엔 또 어디야"; //업적 제목
    private string require = "사망 횟수 1,000번"; //업적 달성 조건 문구
