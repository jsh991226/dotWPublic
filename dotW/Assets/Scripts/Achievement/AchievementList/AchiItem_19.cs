...
public class AchiItem_19 : AchievementItemManager
{
    public int code = 19;   //업적 넘버링
    public string title = "비가 오고 난 후 고요함"; //업적 제목
    private string require = "5스테이지에서 100번 점프"; //업적 달성 조건 문구
    private int levelNum = 1; //별 개수(레벨)
    private string clmName = "jumpStage5"; //컬럼 이름
